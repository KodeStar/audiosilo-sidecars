...
{{if .HasSeriesPrior}}- `series-previously.md` - the published recap of the volume BEFORE this one: the
  sanctioned source for the `chapter: 0` `scope: "series"` recap, and the ground
  truth if a prior finding touched it.
