...
{{if .HasSeriesPrior}}- `series-previously.md` - the community metadata database's published recap of the
  volume BEFORE this one. It is the sanctioned source for the `chapter: 0`
  ...
  this file does not state. It is NOT evidence about this book - a claim about THIS
  book still traces to the fact notes.
